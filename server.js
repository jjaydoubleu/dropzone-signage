...
// Proxy endpoint: controller sends image → Gemini API → returns extracted data
...
<style>
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  #inner { display:table-cell; vertical-align:middle; padding:20px 60px; }
  ...
  .name-bullet { color: #e87c2a; font-size: 11px; }
  .name-text { font-size: 22px; font-weight: bold; color: #ffffff; letter-spacing: 1px; }
